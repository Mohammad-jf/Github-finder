...
const User = () => {
    ...
    useEffect(() => {
        const getUserData = async () => {
            ...
            const data = await getUserInfo(params.login)
            ...
            <>
                <div className="w-full mx-auto lg:w-10/12 ">
                        ...
                        <div className="col-span-2">
                            <div className="mb-6">
                                ...
                                <div className="mt-4 card-actions">
                                    <a className='btn btn-outline' href={html_url} target='-blank' rel='noreferrer'>Visit github profile</a>
                                </div>
                            </div>
                    ...
                    <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats">
                        <div className='grid grid-cols-1 xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-2'>
                            <div className="stat">
